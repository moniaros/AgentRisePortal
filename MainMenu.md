...
## Version 1.2 (AI Opportunities Hub)

-   **Date:** 2024-10-29
-   **Description:** Added a new "Opportunities Hub" submenu item under the "Sales Pipeline" group.
-   **Reason:** To provide a centralized page for agents to view all verified, actionable sales opportunities generated by the AI Policy Scanner, making it easy to prioritize follow-up actions.
-   **Before/After Summary:**
    -   **Before:** The "Sales Pipeline" group contained "Leads Inbox," "Opportunity Pipeline," and "My Day."
    -   **After:** The "Opportunities Hub" link was added to this group.
...
| | Opportunities Hub | `/opportunities-hub` | `OpportunitiesHub.tsx`| All Users |
