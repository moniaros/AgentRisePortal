...
// Dashboard data
export const fetchInquiries = (): Promise<TransactionInquiry[]> => simulateDelay([{ id: '1', agencyId: 'agency_1', createdAt: new Date().toISOString() }]);
export const fetchOpportunities = (): Promise<Opportunity__EXT[]> => simulateDelay([{ id: '1', agencyId: 'agency_1', nextFollowUpDate: new Date(Date.now() - 86400000).toISOString(), stage: 'contacted', value: 1200 }]);
export const fetchInteractions = (): Promise<Interaction[]> => simulateDelay([{ id: '1', agencyId: 'agency_1', direction: 'inbound', read: false }]);
...
export const fetchAllOpportunities = (): Promise<Opportunity__EXT[]> => simulateDelay([{ id: '1', agencyId: 'agency_1', nextFollowUpDate: new Date(Date.now() - 86400000).toISOString(), stage: 'contacted', value: 1200 }]);
