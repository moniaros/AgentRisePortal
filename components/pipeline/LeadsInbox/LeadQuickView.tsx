...
const LeadQuickView: React.FC<LeadQuickViewProps> = ({ inquiry, isOpen, onClose, onCreateOpportunity }) => {
    ...
    const handleGenerateScript = async (angle: 'tax' | 'value' | 'bank_objection' | 'expensive_objection') => {
        ...
        try {
            ...
            const prompt = `
                ...
                Write a short, persuasive sales script (optimized for WhatsApp/SMS - keep it under 60 words) for this lead.
                ...
                <div className="flex-grow overflow-y-auto p-6 space-y-6">
                    ...
                    {activeTab === 'details' ? (
                        <>
                            ...
                            {/* Journey */}
                            <div>
                                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Customer Journey</h3>
                                <div className="relative pl-4 border-l-2 border-gray-200 dark:border-gray-700 space-y-6">
                                    <div className="relative">
                                        <div className="absolute -left-[21px] top-1 w-3 h-3 bg-gray-300 rounded-full border-2 border-white dark:border-gray-800"></div>
                                        <p className="text-xs text-gray-500">Campaign Click</p>
                                        <p className="text-sm font-medium">{inquiry.attribution?.utm_source || 'Direct'} / {inquiry.attribution?.utm_medium || 'None'}</p>
                                    </div>
                                    <div className="relative">
                                        ...
                                        <p className="text-sm font-medium text-green-600 dark:text-green-400">Inquiry Received</p>
                                    </div>
                                </div>
                            </div>
                        </>
