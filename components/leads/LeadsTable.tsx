...
const LeadsTable: React.FC<LeadsTableProps> = ({ leads, onViewDetails, onConvert }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-slate-200 dark:divide-slate-700">
            {leads.length > 0 ? leads.map(lead => (
              <tr key={lead.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors cursor-default">
