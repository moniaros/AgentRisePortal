...
class ErrorBoundary extends Component<Props, State> {
  ...
  // The errors about `this.state` and `this.props` not existing suggest a potential
  // issue with the component's lifecycle/setup, and this is a more modern syntax.
  public state: State = {
    hasError: false,
    error: undefined,
  };
