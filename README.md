...
13. [Social Media Integration](#social-media-integration)
...
The Social Media Integration section, found under **Settings > Application Settings**, allows agents to securely connect their social media accounts to the AgentRise platform. This is the foundational step for enabling powerful marketing features like the Social Composer, Ad Campaigns, and social lead capture.
...
2.  Locate the **Social Media Integration** card.
3.  Click the **"Connect"** button next to the desired platform.
4.  A permissions modal will appear, detailing the access AgentRise requires. This is a simulation of the standard OAuth consent screen from each platform.
5.  Click **"Allow"** to grant permissions.

Upon successful connection, the UI will update to show a "Connected" status, along with the name of the connected profile or page.

*(Note: In this demo, the authentication flow is simulated. A real application would redirect to the social platform for OAuth.)*

### Permissions

To provide a seamless experience, AgentRise requests the following permissions. Our use of this data is strictly for outbound marketing and analytics purposes, compliant with GDPR and other data privacy regulations.

| Platform | Requested Permissions | Purpose |
| :--- | :--- | :--- |
| **Facebook** | `pages_read_engagement`, `pages_manage_posts`, `pages_show_list` | To read page analytics, publish posts on your behalf, and manage comments. |
| **Instagram** | `instagram_basic`, `instagram_content_publish` | To access profile info and publish content to your feed. |
| **LinkedIn** | `r_liteprofile`, `w_member_social` | To retrieve your basic profile and post updates on your behalf. |
| **X (Twitter)**| `tweet.read`, `tweet.write`, `users.read` | To read your profile information and post tweets for you. |

### Disconnecting and Re-authentication

-   To **disconnect** an account, simply click the "Disconnect" button. This will revoke the application's access.
-   If a token expires or permissions change, the status may show an error. You will be prompted to **re-authenticate** by following the connection process again.

### Future Roadmap

-   **Q4 2024:** Integration with Campaign Analytics to display social media performance metrics directly in AgentRise.
-   **Q1 2025:** Automated lead capture from Facebook Lead Ads and LinkedIn Lead Gen Forms.
